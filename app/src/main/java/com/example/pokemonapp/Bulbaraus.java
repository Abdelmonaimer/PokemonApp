...
import com.example.pokemonapp.databinding.ActivityBulbarausBinding;
import com.example.pokemonapp.databinding.ActivityCharmanderBinding;

public class Bulbaraus extends AppCompatActivity {
    ActivityBulbarausBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityBulbarausBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());


        startAnimationCounter_HP(0,60);
        startAnimationCounter_ATK(0,20);
        startAnimationCounter_DEF(0,40);
        startAnimationCounter_SPD(0,35);
