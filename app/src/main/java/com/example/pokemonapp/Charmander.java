...
public class Charmander extends AppCompatActivity {
    ActivityCharmanderBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityCharmanderBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        startAnimationCounter_HP(0,40);
        startAnimationCounter_ATK(0,60);
        startAnimationCounter_DEF(0,40);
        startAnimationCounter_SPD(0,45);
